...
export const projects: Project[] = [
  ...
  },
  {
    ...
    hue: 210,
    year: "2025",
    credits: ["Motion Design: Edu Menezes", "Agency: GUT Miami"],
    overview: "Google Pixel repositioned itself as the world's most inclusive phone by putting accessibility at the center of the work.",
    brief: "In 2021 Pixel held just 2.5% of the market while rivals shouted about flashy features — and Google's own data showed those features weren't connecting with underrepresented audiences.",
    idea: "Bring Pixel's accessibility features to the front and commit to them — a three-year campaign to reposition Pixel as the most inclusive phone ever made.",
    result: "An effectiveness case with GUT Miami, charting a three-year shift in the industry narrative and Pixel's place in it.",
    video: "google-pixel.mp4",
    duration: "2:10",
    hasFilm: true,
  },
  {
    slug: "mission-dry",
    timecode: "00:30:05:00",
    title: "Mission Dry",
    client: "Goodnites",
    agency: "GUT Miami",
    hue: 225,
    year: "2025",
    credits: ["Motion Design: Edu Menezes", "Agency: GUT Miami"],
    overview: "Goodnites broke the stigma of bedwetting by connecting kids with the one group who also rely on absorption tech to stay dry — astronauts.",
    brief: "One in six kids in the U.S. carries lasting self-esteem issues from bedwetting. Goodnites wanted to do more than protect — to show them they're not alone.",
    idea: "Mission Dry: reframe bedwetting through astronauts, who need the same absorption system to stay dry — and let kids interview a real astronaut about anything.",
    result: "A campaign with GUT Miami that turned a source of shame into a point of pride, connecting kids with the people they look up to most.",
    video: "mission-dry.mp4",
    duration: "2:09",
    hasFilm: true,
  },
  {
    ...
    hue: 300,
    year: "2023",
    credits: ["Motion Design / Animation / Post: Edu Menezes", "Agency: BBH New York"],
    overview: "A children's book answering Florida's book bans and the governor's own memoir — giving a voice back to LGBTQ youth.",
    brief: "Florida's \"Don't Say Gay\" law and book bans were silencing LGBTQ youth — and the governor behind them had just published a book called \"The Courage to Be Free\".",
    idea: "Answer it with a children's book — \"The Courage to Be Truly Free\" — launched the same day, free to download, following a zebra named Coco who learns to be himself.",
    result: "A campaign for the Alliance for LGBTQ Youth with BBH New York that turned a ban into a free educational tool, built for Cannes Lions.",
    video: "courage-to-be-free.mp4",
    duration: "1:58",
    hasFilm: true,
  },
  {
    slug: "glad-le-partie",
    timecode: "00:32:35:00",
    title: "Le Partie",
    client: "Glad",
    agency: "FCB Chicago",
    hue: 330,
    year: "2023",
    credits: ["Motion Design / Editing: Edu Menezes", "Agency: FCB Chicago"],
    overview: "Glad launched a scented pink trash bag the only way it deserved — as an over-the-top luxury fragrance film.",
    brief: "Glad's new Force Flex Plus arrived with a cherry-blossom scent and a pink bag — for a multicultural audience that prizes being unapologetically, extravagantly themselves.",
    idea: "Sell the scented trash bag like a high-fragrance ad — strength, desire, a scent so alluring it could only belong to a powerful trash bag. Being extra, on purpose.",
    result: "A campaign with FCB Chicago that slayed category standards by launching a scented bag in the most extra way possible.",
    video: "glad-le-partie.mp4",
    duration: "1:49",
    hasFilm: true,
  },
  {
    slug: "privacy-protector",
    timecode: "00:33:50:00",
    ...
    year: "2023",
    credits: ["Motion Design / Editing: Edu Menezes", "Agency: FCB Chicago"],
    overview: "Discover launched Privacy Protector — one tap to erase your personal data from the brokers selling it.",
    brief: "Data brokers make $200 billion a year selling Americans' personal information — and the problem keeps getting worse.",
    idea: "A first-of-its-kind tool inside the Discover app: a single tap makes your personal information disappear from unwanted places online, reversing years of collection.",
    result: "Over a million enrollments with FCB Chicago — security, peace of mind and control handed back to users.",
    video: "privacy-protector.mp4",
    duration: "1:08",
    hasFilm: true,
  },
  {
    slug: "gerber-baby",
    timecode: "00:35:05:00",
    title: "First Adopted Gerber Baby",
    client: "Gerber",
    agency: "Ogilvy New York",
    hue: 35,
    year: "2021",
    credits: ["Motion Design: Edu Menezes", "Agency: Ogilvy New York"],
    overview: "Gerber named its first adopted spokesbaby in a century — Magnolia — redefining what a family looks like.",
    brief: "The Gerber baby has been an American icon for 100 years — but it had never reflected the families that don't necessarily match.",
    idea: "Make Magnolia the first adopted Gerber baby in the company's history — so any family that doesn't match sees that belonging is never in question.",
    result: "A milestone for Gerber with Ogilvy New York: the first adopted spokesbaby, and a national conversation about adoption and belonging.",
    video: "gerber.mp4",
    duration: "2:04",
    hasFilm: true,
  },
