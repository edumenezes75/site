...
export default function Agencies() {
  return (
    <section className="bg-bg text-fg px-6 md:px-12 py-20 md:py-28 border-t border-fg/10">
      <p className="font-mono text-[10px] uppercase tracking-[0.25em] text-fg/50">Agencies</p>
      ...
      <p className="mt-14 font-mono text-[10px] uppercase tracking-[0.25em] text-fg/50">Brands</p>
